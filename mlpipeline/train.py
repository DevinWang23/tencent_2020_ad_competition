...
#     logger.info(model.predict(eval_df[cate_cols + cont_cols][:2]))
...
#         acc_y = __eval_metrics(eval_df['y'], eval_df['pred'])
...
def train(
    ...
    logger.info("using_fe_df: %s, use_label: %s, is_eval: %s, model_type: %s, model_name: %s, use_log: %s, use_std: %s, use_cv: %s, n_splits: %s"%(fe_filename,
                 use_label_col[0],                                                                                             
                 is_eval,
                 model_type,
                 model_name,
